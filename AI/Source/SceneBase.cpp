	...
	FPS(0.0f)
{
	...
	skeleSpriteAni->AddAni("SkeleThrustRight", 7 * 13, 7 * 13 + 8);
	...
	reptileSpriteAni->AddAni("ReptileStaticUp", 0, 4);
	reptileSpriteAni->AddAni("ReptileStaticDown", 0, 4);
	reptileSpriteAni->AddAni("ReptileStaticLeft", 0, 4);
	reptileSpriteAni->AddAni("ReptileStaticRight", 0, 4);
	reptileSpriteAni->AddAni("ReptileMoveUp", 0, 4);
	reptileSpriteAni->AddAni("ReptileMoveDown", 0, 4);
	reptileSpriteAni->AddAni("ReptileMoveLeft", 0, 4);
	reptileSpriteAni->AddAni("ReptileMoveRight", 0, 4);
	reptileSpriteAni->AddAni("ReptileShootUp", 0, 4);
	reptileSpriteAni->AddAni("ReptileShootDown", 0, 4);
	reptileSpriteAni->AddAni("ReptileShootLeft", 0, 4);
	reptileSpriteAni->AddAni("ReptileShootRight", 0, 4);
	reptileSpriteAni->AddAni("ReptileProcreate", 0, 4);
	reptileSpriteAni->AddAni("ReptileFacePlant", 0, 4);

	SpriteAni* const boySpriteAni = static_cast<SpriteAni*>(meshList[(int)GeoType::Boy]);
	boySpriteAni->AddAni("BoyStaticUp", 0, 4);
	boySpriteAni->AddAni("BoyStaticDown", 0, 4);
	boySpriteAni->AddAni("BoyStaticLeft", 0, 4);
	boySpriteAni->AddAni("BoyStaticRight", 0, 4);
	boySpriteAni->AddAni("BoyMoveUp", 0, 4);
	boySpriteAni->AddAni("BoyMoveDown", 0, 4);
	boySpriteAni->AddAni("BoyMoveLeft", 0, 4);
	boySpriteAni->AddAni("BoyMoveRight", 0, 4);
	boySpriteAni->AddAni("BoySlashUp", 0, 4);
	boySpriteAni->AddAni("BoySlashDown", 0, 4);
	boySpriteAni->AddAni("BoySlashLeft", 0, 4);
	boySpriteAni->AddAni("BoySlashRight", 0, 4);
	boySpriteAni->AddAni("BoyHeal", 0, 4);
	boySpriteAni->AddAni("BoyFacePlant", 0, 4);
